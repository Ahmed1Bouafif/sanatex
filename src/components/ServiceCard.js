    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-5  sm:gap-2 z-10 font-semibold ">
          <h3
            className={`text-center lg:text-start text-2xl sm:text-lg group-hover:text-white text-black ${
              isActive ? 'text-white' : ''
            }`}
          >
            {capitalize(t(name))}
          ...
          >
            <h4
              className={`group-hover:text-white text-black hidden lg:flex ${
                isActive ? 'text-white' : ''
              }`}
            >
              Learn more
            ...
            <span>
              ...
              <ChevronDoubleDownIcon
                className={`h-6 w-6 justify-self-end group-hover:stroke-white text-black ${
                  isActive ? 'rotate-180 stroke-white' : 'rotate-0'
                } transition-all`}
              />
            </span>
          </button>
