      ...
      <div className="flex flex-col">
        ...
        <div className="hidden md:flex lg:hidden flex-col ">
          ...
          <Collapse isOpened={activeService && activeService <= 2}>
            <div
              className={`bg-black dark:bg-white dark:text-black text-white p-8 font-heading hidden md:block lg:hidden`}
            >
        ...
        <div className="hidden lg:flex lg:flex-col">
          ...
          <Collapse isOpened={activeService && activeService <= 4}>
            <div
              className={`bg-black text-white dark:bg-white dark:text-black p-8 font-heading hidden lg:block`}
            >
              {services[activeService - 1]?.description ||
                services[prev - 1]?.description}
            </div>
          ...
          <Collapse isOpened={activeService && activeService > 4}>
            <div
              className={`bg-black dark:bg-white dark:text-black text-white p-8 font-heading hidden lg:block`}
            >
              {services[activeService - 1]?.description ||
                services[prev - 1]?.description}
            </div>
