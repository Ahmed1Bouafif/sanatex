...
export const Hero = () => {
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32 ">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">MultiNet Communication, your partner for planning, realisation and maintenance of wired telecommunication networks.</p>
      ...
      <div className="mt-36 lg:mt-44">
        <h3 className="font-display text-base text-slate-900">Trusted by these six companies so far</h3>
