      ...
      <Container className=" pt-20 pb-16 text-center  ">
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl ">
          ...
          <span className="relative whitespace-nowrap">
            ...
            <span className="relative text-blue-600 font-heading">Sanatex</span>
          </span>{" "}
          Dienstleistungen
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">{/* {t("headerDescription")} */}Sanatex GmbH – die neuste Generation von schneller und intelligenter Technologie. Wir bringen Sie auf das höchste Level.</p>
        <div className="mt-10 flex flsex-col ssm:flex-row justify-center gap-2 sm:gap-6">
          <Button2 variant={"invert"} to={"/contact"} className="group">
            {/* {startCase(t("getInTouch"))} */}kontaktiere uns
          </Button2>
          <Button2 variant={"accent"} to={"#"} className="group">
            <svg aria-hidden="true" className={`h-3 w-3 flex-none group-hover:fill-white transition-all fill-black group-active:fill-current`}>
              <path d="m9.997 6.91-7.583 3.447A1 1 0 0 1 1 9.447V2.553a1 1 0 0 1 1.414-.91L9.997 5.09c.782.355.782 1.465 0 1.82Z"></path>
            </svg>
            <span className="group-hover:text-white transition ml-3">Video ansehen</span>
          </Button2>
          {/* 
